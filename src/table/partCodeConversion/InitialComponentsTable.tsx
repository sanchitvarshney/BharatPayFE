...
const InitialComponentsTable: React.FC<Props> = ({ rowData, setRowData }) => {
  // Add new row
  const handleAddRow = () => {
    const newRow: InitialComponent = {
  ...
  const components = {
    textInputCellRenderer: (params: any) => {
      return <ComponentCellRenderer props={params} showStockInfo={true} />;
    },
  };
...
export default InitialComponentsTable;
