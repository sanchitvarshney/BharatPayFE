  ...
  return (
    <div>
      <div className=" ag-theme-quartz h-[calc(100vh-85px)]">
        <AgGridReact ref={gridRef} loading={getQ1DataLoading} overlayNoRowsTemplate={OverlayNoRowsTemplate} suppressCellFocus={true} rowData={rowData} columnDefs={columnDefs} defaultColDef={defaultColDef} pagination={true} paginationPageSize={10} />
      </div>
    </div>
  );
};
