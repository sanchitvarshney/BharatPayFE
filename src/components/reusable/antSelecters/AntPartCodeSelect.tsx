...
const AntPartCodeSelect: React.FC<Props> = ({ value, onChange, label = "Search Item", width = "100%", getUom }) => {
  ...
  return (
    <Select
      ...
      onChange={(selectedValue) => {
        ...
        onChange({ value: selectedItem!.part_code, label: `${selectedItem?.part_code} - ${selectedItem?.text}` });
        if (getUom) {
...
export default AntPartCodeSelect;
