...
const MasterFGproductUpdateDrawer: React.FC<Props> = ({ open, setOpen }) => {
  return (
    <div>
      <CustomDrawer open={open} onOpenChange={setOpen}>
        <CustomDrawerContent side="right" className="min-w-[50%] p-0">
          ...
          <div className="h-[calc(100vh-110px)] overflow-y-auto flex flex-col gap-[30px] px-[20px] ">
            ...
            <fieldset className="border p-[20px] rounded-md">
              <legend className="text-slate-600 font-[600]">Advance Details</legend>
              <div className="grid grid-cols-3 gap-[30px]">
                <CustomInput label="Brand" />
                <CustomInput label="EAN" />
            ...
            <fieldset className="border p-[20px] rounded-md">
              <legend className="text-slate-600 font-[600]">Production Plan and Costing</legend>
              <div className="grid grid-cols-3 gap-[30px]">
                <CustomInput label="MIN Stock (FG)" />
                <CustomInput label="MIN Stock(RM)" />
                <CustomInput label="MFG Batch Size" />
                <CustomInput label="Default Stock Location" />
                <CustomInput label="Labour Cost" />
                <CustomInput label="Sec Packing Cost" />
                <CustomInput label="JW Cost" />
...
export default MasterFGproductUpdateDrawer;
