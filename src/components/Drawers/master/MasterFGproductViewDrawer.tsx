...
const MasterFGproductViewDrawer: React.FC<Props> = ({ open, setOpen }) => {
  return (
    <div>
      <CustomDrawer open={open} onOpenChange={setOpen}>
        <CustomDrawerContent side="right" className="min-w-[40%] p-0">
          ...
          <div className="h-[calc(100vh-110px)] overflow-y-hidden"></div>
        </CustomDrawerContent>
      </CustomDrawer>
    </div>
  );
...
export default MasterFGproductViewDrawer;
