...
export const SocketProvider: React.FC<Props> = ({ children }) => {
  ...
  return <SocketContext.Provider value={{ emitDownloadReport, onDownloadReport, isConnected, refreshConnection, isLoading, off, onnotification,emitGetNotification,emitDownloadR4Report,emitDownloadR2Report,emitDownloadR10Report }}>{children}</SocketContext.Provider>;
};
