...
const PercentageComponentLayout = (props: { children: React.ReactNode }) => {
  return (
    <div className="">
        ...
        <ul className="group flex items-center h-[50px]">
          <li className="h-[50px]">
            <NavLink
              ...
              to="/master-components/percentage"
              className={({ isActive }) =>
...
export default PercentageComponentLayout;
