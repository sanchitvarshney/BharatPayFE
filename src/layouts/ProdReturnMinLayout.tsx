...
const ProdReturnMinLayout : React.FC<Props> = ({ children }) => {
  const navigate = useNavigate();
  const location = useLocation();

  // Determine the active tab based on the current route
  const tabRoutes = ["/warehouse/prod-return-MIN", "/warehouse/prod-return-min-approve"];
...
export default ProdReturnMinLayout ;
