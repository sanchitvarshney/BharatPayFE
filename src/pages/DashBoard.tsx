      ...
      <main className="flex flex-col flex-1 gap-2 p-2 md:gap-2 md:p-3 h-[calc(100vh-50px)] overflow-y-auto">
        <div className="grid gap-2 md:grid-cols-2 md:gap-2 lg:grid-cols-4">
          <Card x-chunk="dashboard-01-chunk-0">
            <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
              <CardTitle className="text-sm font-medium text-slate-600">Total FG</CardTitle>
              <DollarSign className="w-4 h-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-slate-600">45,231.89</div>
              <p className="text-xs text-muted-foreground">+20.1% from last month</p>
            </CardContent>
          </Card>
          <Card x-chunk="dashboard-01-chunk-1">
            <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
              <CardTitle className="text-sm font-medium text-slate-600">Total SFG</CardTitle>
              <Users className="w-4 h-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-slate-600">+2350</div>
          ...
          <Card x-chunk="dashboard-01-chunk-2">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-slate-600">+12,234</div>
        ...
        <div className="grid gap-2 md:gap-2 lg:grid-cols-2 xl:grid-cols-3">
          <Card className="xl:col-span-2" x-chunk="dashboard-01-chunk-4">
            <CardHeader className="flex flex-row items-center">
              <div className="grid gap-2">
                <CardTitle className="text-slate-600">Transactions</CardTitle>
                <CardDescription>Recent transactions from your store.</CardDescription>
              </div>
              <Button asChild size="sm" className="gap-1 ml-auto bg-cyan-700 hover:bg-cyan-800">
                <Link to="#">
                  View All
          ...
          <Card x-chunk="dashboard-01-chunk-5">
            <CardHeader>
              <CardTitle className="text-slate-600">Recent Sales</CardTitle>
            </CardHeader>
