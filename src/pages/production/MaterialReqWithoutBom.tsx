              ...
              <div>
                ...
                <CardContent className="flex flex-col gap-[20px] py-[20px]">
                  ...
                  <div className="flex items-center ">
                    <Checkbox id="terms" className="data-[state=checked]:bg-cyan-800 data-[state=checked]:text-[#fff] border-slate-400" {...register("checkbox")} /> {/*checked marked permanently  for move to trc*/ }
