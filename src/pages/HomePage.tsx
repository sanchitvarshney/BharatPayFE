...
const HomePage = () => {
  return (
    <div className="h-[calc(100vh-50px)] overflow-y-auto bg-white">
      <div className="w-full h-full px-[200px]  py-[10px] flex items-center justify-center">
        <div>
          ...
          <div className="flex  items-center mt-[30px] gap-[20px]">
            <div className="h-[150px] w-[250px] bg-cyan-500/30 rounded-md flex flex-col items-center justify-center gap-[3px]">
              ...
              <Link to={"/"} className="flex items-center gap-[5px]">
                <p className="text-cyan-800 font-[600]">Master</p>
      ...
      <div className="h-[200px] bg-zinc-100 px-[200px] flex items justify-between py-[20px]">
        ...
        <div className="flex flex-col gap-[10px] w-[500px] items-end text-right justify-end">
          <img src="./ms.png" alt="" className="w-[200px]" />
          <div>
